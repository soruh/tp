...
void daCow_c::action_angry() {
    ...
    case daCow_Mode_WaitingForMorf_e:
        ...
        case daCow_Crazy_Dash_e: {
            ...
            int lockedOn = false;
            if (mRunDuration && mTimer2 && dComIfGp_getAttention().LockonTruth() &&
